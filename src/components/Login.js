...
export default class Login extends Component {
    ...
    login =  (event) => {
       ...
       auth.signInWithEmailAndPassword(this.state.useremail, this.state.password).then((response) => {
            this.setState({
                useremail:'',
                password:''
            })
        ...
        return (
            ...
            <form>
                ...
                <div className="form-group">
                    ...
                    required value={this.state.useremail} onChange={this.handleFormChange}  />
                </div>
